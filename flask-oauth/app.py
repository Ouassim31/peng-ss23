...
SCOPES = ['https://www.googleapis.com/auth/drive.metadata.readonly','https://www.googleapis.com/auth/fitness.activity.read','https://www.googleapis.com/auth/fitness.body.read']
...
def test_api_request():
  ...
  files = fitness.users().dataset().aggregate(userId = "me",body=request_body).execute()
